        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SpoilerMode = table.Column<int>(type: "integer", nullable: false),
                    PrimarySeriesId = table.Column<Guid>(type: "uuid", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LayoutMapUrl = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Grandstands", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Grandstands_Circuits_CircuitId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OpenF1MeetingKey = table.Column<int>(type: "integer", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Entrants_Drivers_DriverId",
                        column: x => x.DriverId,
                        principalTable: "Drivers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Entrants_Rounds_RoundId",
                        column: x => x.RoundId,
                        principalTable: "Rounds",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Entrants_Teams_TeamId",
                        column: x => x.TeamId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OpenF1SessionKey = table.Column<int>(type: "integer", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ListItems_Sessions_SessionId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserId = table.Column<Guid>(type: "uuid", nullable: false),
                    SessionId = table.Column<Guid>(type: "uuid", nullable: false),
                    StarRating = table.Column<decimal>(type: "numeric(2,1)", precision: 2, scale: 1, nullable: true),
                    ExcitementRating = table.Column<int>(type: "integer", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Results_Entrants_EntrantId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GrandstandId = table.Column<Guid>(type: "uuid", nullable: true),
                    SeatDescription = table.Column<string>(type: "text", nullable: true),
                    VenueRating = table.Column<int>(type: "integer", nullable: true),
                    ViewRating = table.Column<int>(type: "integer", nullable: true),
                    AccessRating = table.Column<int>(type: "integer", nullable: true),
                    FacilitiesRating = table.Column<int>(type: "integer", nullable: true),
                    AtmosphereRating = table.Column<int>(type: "integer", nullable: true),
                    ViewPhotoUrl = table.Column<string>(type: "text", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Experiences", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Experiences_Grandstands_GrandstandId",
                        column: x => x.GrandstandId,
                        principalTable: "Grandstands",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_Experiences_Logs_LogId",
                        column: x => x.LogId,
                        principalTable: "Logs",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Entrants_TeamId",
                table: "Entrants",
                column: "TeamId");

            migrationBuilder.CreateIndex(
                name: "IX_Experiences_GrandstandId",
                table: "Experiences",
                column: "GrandstandId");

            migrationBuilder.CreateIndex(
                name: "IX_Experiences_LogId",
                table: "Experiences",
                column: "LogId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Grandstands_CircuitId",
                table: "Grandstands",
                column: "CircuitId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ListItems_SessionId",
                table: "ListItems",
                column: "SessionId");

            migrationBuilder.CreateIndex(
                name: "IX_Logs_LoggedAt",
                table: "Logs",
                column: "LoggedAt");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Logs_UserId_SessionId",
                table: "Logs",
                columns: new[] { "UserId", "SessionId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Results_EntrantId",
                table: "Results",
                column: "EntrantId");

            migrationBuilder.CreateIndex(
                name: "IX_Results_SessionId_EntrantId",
                table: "Results",
                columns: new[] { "SessionId", "EntrantId" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Rounds_OpenF1MeetingKey",
                table: "Rounds",
                column: "OpenF1MeetingKey");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Seasons_SeriesId_Year",
                table: "Seasons",
                columns: new[] { "SeriesId", "Year" },
                unique: true);
